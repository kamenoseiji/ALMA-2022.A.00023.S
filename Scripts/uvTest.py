#--------
# This is a test code to check the sing convension of X and Y axes in uvmodelfit() in CASA
#--------
...
#-------- Check position shift in the image
...
#-------- uvmodelfit for the position-shift image
